...
library("nmixgof")
  ...
  # set directory
setwd("C:/Users/DiNicola_W/Desktop/Jonas_Trepel")


occ_length_3<-read.csv("red_deer_occasion_lentgh_count_3days.csv") 
colnames(occ_length_3)[which(names(occ_length_3) == "X")] <- "CT_id"  

# load dataframes with predictors
vars<-read.csv("CT_variables_25833.csv") 
...
save(p3.1.2.1, file="p3_1_2_1_nopred.RData")
load("p3_1_2_1_nopred.RData")
